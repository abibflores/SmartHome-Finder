  ...
  return (
    <div className="w-full max-w-4xl">
      ...
      <p className="mt-2 text-sm text-gray-500">
        Usa lenguaje natural para describir lo que buscas. Por ejemplo: &quot;Casa de 3 habitaciones con jardín en Toluca&quot; o &quot;Apartamento con terraza cerca del centro de Metepec&quot;
      </p>
